...
EmberWatson.prototype.transformEmberDataAsyncFalseRelationships = function(rootPath, dryRun, exclude) {
  ...
  var description = "Convert Ember Data relationship with implicit async: false to explicit option (ember watson:convert-ember-data-async-false-relationships)";
...
EmberWatson.prototype.transformEmberDataModelLookups = function(rootPath, dryRun, exclude) {
  ...
  var description = "Convert Ember Data model lookups to use a dasherized string (ember watson:convert-ember-data-model-lookups)";
...
EmberWatson.prototype.transformQUnitTest = function(rootPath, dryRun, exclude) {
  ...
  var description = "Fix QUnit tests to match 2.0 syntax (ember watson:upgrade-qunit-tests)";
...
EmberWatson.prototype.transformPrototypeExtensions = function(rootPath, dryRun, exclude) {
  ...
  var description = "Convert computed properties and observers to not use prototype extensions (ember watson:convert-prototype-extensions)";
